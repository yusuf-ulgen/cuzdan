...
class WalletAssetAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            val iconRes = com.yusufulgen.cuzdan.util.AssetUtils.getAssetIcon(asset.symbol, asset.assetType)
            ...
            val colorRes = when {
                sign > 0 -> com.yusufulgen.cuzdan.R.color.accent_green
                sign < 0 -> com.yusufulgen.cuzdan.R.color.accent_red
                else -> {
                    val typedValue = android.util.TypedValue()
                    holder.itemView.context.theme.resolveAttribute(com.yusufulgen.cuzdan.R.attr.textSecondary, typedValue, true)
