...
import com.yusufulgen.cuzdan.databinding.ItemReportCategoryBinding
import com.yusufulgen.cuzdan.databinding.ItemAssetBinding
import com.yusufulgen.cuzdan.util.formatCurrency
import java.math.BigDecimal

data class ReportCategory(
    val type: com.yusufulgen.cuzdan.data.local.entity.AssetType,
    val name: String,
    val totalValue: BigDecimal,
    val changePerc: BigDecimal,
    val changeAbs: BigDecimal,
    val assets: List<com.yusufulgen.cuzdan.data.local.entity.Asset>
)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if (isPrivacyEnabled) {
                ...
                val colorAttr = when {
                    isNeutral -> com.yusufulgen.cuzdan.R.attr.textSecondary
                    isProfit -> com.yusufulgen.cuzdan.R.attr.pill_green_text
                ...
                textCategoryValue.setTextColor(holder.itemView.context.obtainStyledAttributes(intArrayOf(com.yusufulgen.cuzdan.R.attr.textPrimary)).getColor(0, 0))
...
class ReportAssetInlineAdapter(
    private val assets: List<com.yusufulgen.cuzdan.data.local.entity.Asset>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if (isPrivacyEnabled) {
                ...
                tvAssetChangePerc.setTextColor(holder.itemView.context.getColor(com.yusufulgen.cuzdan.R.color.text_label))
                tvAssetPrice.setTextColor(holder.itemView.context.obtainStyledAttributes(intArrayOf(com.yusufulgen.cuzdan.R.attr.textPrimary)).getColor(0, 0))
                tvAssetChangeAbs.setTextColor(holder.itemView.context.getColor(com.yusufulgen.cuzdan.R.color.text_label))
            } else {
