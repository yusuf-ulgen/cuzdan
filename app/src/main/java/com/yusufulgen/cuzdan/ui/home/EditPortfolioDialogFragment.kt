...
import com.yusufulgen.cuzdan.databinding.DialogEditPortfolioBinding
...
class EditPortfolioDialogFragment : DialogFragment() {
    ...
    private fun setupListeners() {
        binding.btnSave.setOnClickListener {
            ...
            if (name.isEmpty()) {
                binding.editPortfolioName.error = getString(com.yusufulgen.cuzdan.R.string.portfolio_name_hint)
            } else {
