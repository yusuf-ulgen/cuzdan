...
class ChartMarkerView(context: Context, private val dataPoints: List<com.yusufulgen.cuzdan.data.local.entity.PortfolioHistory>) : MarkerView(context, R.layout.layout_chart_marker) {
